package com.villera.security.jwt;
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try {
			...
			if (jwt != null && tokenProvider.validateJwtToken(jwt)) {
				...
				UsernamePasswordAuthenticationToken authenticationadmin = new UsernamePasswordAuthenticationToken(
						adminDetails, null, adminDetails.getAuthorities());
				authenticationadmin.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));
				...
				UsernamePasswordAuthenticationToken authenticationemp = new UsernamePasswordAuthenticationToken(
						employeeDetails, null, employeeDetails.getAuthorities());
				authenticationemp.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));
